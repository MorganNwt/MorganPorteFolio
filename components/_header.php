...
<nav class="nav-flex-2">
    ...
    <?php
        ...
        if (isset($loginUser)) {
            ...
            echo '<p class="nav-log"> Bonjour ' . $login . '</p>';
    ...
    <div class="nav-flex">
        ...
        <?php if (isset($userId)): ?>
            ...
            <a href="<?php echo $basePath; ?>services/db_deconnexion"> 
            <img src="../images/Deco.jpg" alt="Image de rawpixel.com sur Freepik" class="nav-deconnexion"> 
            </a>
        <?php endif; ?>
    </div>
</nav>
